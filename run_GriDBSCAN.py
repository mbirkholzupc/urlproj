"""
.. module:: run_GriDBSCAN

*************

:Description: Utility that simply runs GriDBSCAN when provided with dataset, MinPts (k), Epsilon and grid size
...
# Function courtesy of https://stackoverflow.com/questions/33564246/passing-a-tuple-as-command-line-argument
...
if __name__ == '__main__':
    ...
    ap.add_argument("-x", "--grid", required=True, help='tuple representing grid (sorry, but g was taken). format is "(x,y,z)"', type=tuple_type)
    ...
    # Run GriDBSCAN and show results
    mydbscan = GriDBSCAN(eps=eps,min_samples=k,grid=grid).fit(X)
